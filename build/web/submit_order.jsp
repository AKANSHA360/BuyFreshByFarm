  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
          <a class="nav-link" href="submit_order.jsp">Your Orders</a>                    
      </li>
    </ul>
    
  </div>
</nav> 
        <h1 style="text-align: center">Your order has been<br> successfully placed</h1>
        <%
...
PreparedStatement ps=con.prepareStatement("select * from submitted_order where name=?");  
ps.setString(1,name);
PreparedStatement poos=con.prepareStatement("select sum(total) from orders where name=?");
poos.setString(1,name);
...
while(rs.next())  
{  
out.print("<tr><td>"+rs.getInt(1)+"</td><td>"+rs.getInt(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getInt(4)+"</td><td>"+rs.getInt(5)+"</td><td>Order Submitted</td></tr>");                                    
